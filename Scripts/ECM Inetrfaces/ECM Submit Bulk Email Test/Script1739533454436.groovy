...
//WS.sendRequest(findTestObject('ECM Interfaces OR/ECM Submit Bulk Email QR'))

def authResponse = WS.sendRequest(findTestObject('ECM Interfaces OR/ECM Auth API'))
...
def smsResponse = WS.sendRequest(findTestObject('ECM Interfaces OR/ECM Submit Bulk Email QR', [('jwt_token') : token]))
