...
def authResponse = WS.sendRequest(findTestObject('Nexus Interfaces OR/Nexus Auth API OR'))
...
def smsResponse = WS.sendRequest(findTestObject('Nexus Interfaces OR/Nexus Whatsapp Send QR', [('access_token') : token]))
